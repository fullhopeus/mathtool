...
function controller_midi_in(midiEvent,portName)
	if midiEvent[0] == 0xF0 and midiEvent[1] == 0x7F and midiEvent[2] == 0x7F and midiEvent[3] == 0x06 and midiEvent[5] == 0xF7 then
		if midiEvent[4] == 0x05 then
			return {midi={0xB0,0x35,0x7F}}
		end
		if midiEvent[4] == 0x04 then
			return {midi={0xB0,0x34,0x7F}}
		end
		if midiEvent[4] == 0x01 then
			return {midi={0xB0,0x33,0x7F}}
		end
		if midiEvent[4] == 0x02 then
			return {midi={0xB0,0x36,0x7F}}
		end
		if midiEvent[4] == 0x06 then
			return {midi={0xB0,0x32,0x7F}}
		end
	end
	return nil
end
...
function controller_info()
	return {
		...
		-- USB information to check for the KeyLab 88
		--usb_vendor_id = 7285,	-- Arturia
		--usb_product_id = 717,	-- KeyLab 88
		...
		items = {
				...
				{name='Keyboard', label='KeyLab 88', objectType='Keyboard', midiType='Keyboard', startKey=21, numberKeys=88, midi={0x90,MIDI_Wildcard,MIDI_Wildcard}},
				...
				{name='Volume',  label='Volume', 		objectType='Knob', midi={0xB0,0x07,MIDI_LSB}, outport='KeyLab 88'},
				-- BANK 1
				{name='Knob 1',  label='Cutoff', 		objectType='Knob', midi={0xB0,0x4A,MIDI_LSB}, outport='KeyLab 88'},
				{name='Knob 2',  label='Resonance', 	objectType='Knob', midi={0xB0,0x47,MIDI_LSB}, outport='KeyLab 88'},
				{name='Knob 3',  label='LFO Rate', 		objectType='Knob', midi={0xB0,0x4C,MIDI_LSB}, outport='KeyLab 88'},
				{name='Knob 4',  label='LFO Amount', 	objectType='Knob', midi={0xB0,0x4D,MIDI_LSB}, outport='KeyLab 88'},
				{name='Knob 5',  label='Chorus Amount', objectType='Knob', midi={0xB0,0x5D,MIDI_LSB}, outport='KeyLab 88'},
				{name='Knob 6',  label='Param 1', 		objectType='Knob', midi={0xB0,0x12,MIDI_LSB}, outport='KeyLab 88'},
				{name='Knob 7',  label='Param 2', 		objectType='Knob', midi={0xB0,0x13,MIDI_LSB}, outport='KeyLab 88'},
				{name='Knob 8',  label='Param 3', 		objectType='Knob', midi={0xB0,0x10,MIDI_LSB}, outport='KeyLab 88'},
				{name='Knob 9',  label='Param 4', 		objectType='Knob', midi={0xB0,0x11,MIDI_LSB}, outport='KeyLab 88'},
				{name='Knob 10', label='Delay Amount', 	objectType='Knob', midi={0xB0,0x5B,MIDI_LSB}, outport='KeyLab 88'},
				-- FADERS
				...
				----------------------------------------------------------------------
				-- TRANSPORT CONTROLS ARE CONVERTERD AT THE TOP OF THE SCRIPT BECAUSE THEY USE MMC --
				----------------------------------------------------------------------

				{name='REWIND',  label='REWIND',  objectType='Button', midiType='Single', midi={0xB0,0x35,MIDI_LSB}},
				{name='FORWARD', label='FORWARD', objectType='Button', midiType='Single', midi={0xB0,0x34,MIDI_LSB}},
				{name='STOP',    label='STOP',    objectType='Button', midiType='Single', midi={0xB0,0x33,MIDI_LSB}},
				{name='PLAY',    label='PLAY',    objectType='Button', midiType='Single', midi={0xB0,0x36,MIDI_LSB}},
				{name='RECORD',  label='RECORD',  objectType='Button', midiType='Single', midi={0xB0,0x32,MIDI_LSB}},

				{name='CYCLE',   label='CYCLE', objectType='Button', midiType='Alternating', midi={0xB0,0x37,MIDI_LSB}},
