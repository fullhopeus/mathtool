...
function controller_info()
	return {
		...
		items = {
				...
				{name='Keyboard', label='KeyLab 61', objectType='Keyboard', midiType='Keyboard', startKey=36, numberKeys=61, midi={0x90,MIDI_Wildcard,MIDI_Wildcard}},
				...
				{name='Volume', label='Volume', objectType='Knob', midi={0xB0,0x07,MIDI_LSB}, outport='KeyLab 61'},
				-- BANK 1
				{name='Knob 1', label='Cutoff', objectType='Knob', midi={0xB0,0x4A,MIDI_LSB}, outport='KeyLab 61'},
				{name='Knob 2', label='Resonance', objectType='Knob', midi={0xB0,0x47,MIDI_LSB}, outport='KeyLab 61'},
				{name='Knob 3', label='LFO Rate', objectType='Knob', midi={0xB0,0x4C,MIDI_LSB}, outport='KeyLab 61'},
				{name='Knob 4', label='LFO Amount', objectType='Knob', midi={0xB0,0x4D,MIDI_LSB}, outport='KeyLab 61'},
				{name='Knob 5', label='Chorus Amount', objectType='Knob', midi={0xB0,0x5D,MIDI_LSB}, outport='KeyLab 61'},
				{name='Knob 6', label='Param 1', objectType='Knob', midi={0xB0,0x12,MIDI_LSB}, outport='KeyLab 61'},
				{name='Knob 7', label='Param 2', objectType='Knob', midi={0xB0,0x13,MIDI_LSB}, outport='KeyLab 61'},
				{name='Knob 8', label='Param 3', objectType='Knob', midi={0xB0,0x10,MIDI_LSB}, outport='KeyLab 61'},
				{name='Knob 9', label='Param 4', objectType='Knob', midi={0xB0,0x11,MIDI_LSB}, outport='KeyLab 61'},
				{name='Knob 10', label='Delay Amount', objectType='Knob', midi={0xB0,0x5B,MIDI_LSB}, outport='KeyLab 61'},
				-- FADERS
