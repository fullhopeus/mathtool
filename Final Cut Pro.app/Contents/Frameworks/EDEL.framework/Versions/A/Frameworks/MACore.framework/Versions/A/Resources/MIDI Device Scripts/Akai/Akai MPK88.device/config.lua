...
function controller_info()
	return {
		...
		items = {
				...
				{name='Keyboard', label='MPK88', objectType='Keyboard', midiType='Keyboard', startKey=33, numberKeys=88, midi={0x90,MIDI_Wildcard,MIDI_Wildcard}},
				...
				{name='Button 1', label='S1', objectType='Button', midiType='Alternating', midi={0xB0,0x20,MIDI_LSB}, outport='Port 1'},
				{name='Button 2', label='S2', objectType='Button', midiType='Alternating', midi={0xB0,0x21,MIDI_LSB}, outport='Port 1'},
				{name='Button 3', label='S3', objectType='Button', midiType='Alternating', midi={0xB0,0x22,MIDI_LSB}, outport='Port 1'},
				{name='Button 4', label='S4', objectType='Button', midiType='Alternating', midi={0xB0,0x23,MIDI_LSB}, outport='Port 1'},
				{name='Button 5', label='S5', objectType='Button', midiType='Alternating', midi={0xB0,0x24,MIDI_LSB}, outport='Port 1'},
				{name='Button 6', label='S6', objectType='Button', midiType='Alternating', midi={0xB0,0x25,MIDI_LSB}, outport='Port 1'},
				{name='Button 7', label='S7', objectType='Button', midiType='Alternating', midi={0xB0,0x26,MIDI_LSB}, outport='Port 1'},
				{name='Button 8', label='S8', objectType='Button', midiType='Alternating', midi={0xB0,0x27,MIDI_LSB}, outport='Port 1'},
				...
				{name='Pad 14', label='PAD 14', objectType='Drumpad', midiType='Note', midi={0x91,0x53,MIDI_LSB}},
				{name='Pad 15', label='PAD 15', objectType='Drumpad', midiType='Note', midi={0x91,0x54,MIDI_LSB}},
				{name='Pad 16', label='PAD 16', objectType='Drumpad', midiType='Note', midi={0x91,0x56,MIDI_LSB}},
