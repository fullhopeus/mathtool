...
function controller_info()
	return {
		...
		items = {
				...
				{name='Keyboard', label='Axiom 49', objectType='Keyboard', midiType='Keyboard', startKey=36, numberKeys=49, midi={0x90,MIDI_Wildcard,MIDI_Wildcard}},
				...
				{name='Fader 1', label='D9', objectType='VFader', midi={0xB0,0x4A,MIDI_LSB}},
				{name='Fader 2', label='D10', objectType='VFader', midi={0xB0,0x47,MIDI_LSB}},
				{name='Fader 3', label='D11', objectType='VFader', midi={0xB0,0x5B,MIDI_LSB}},
				{name='Fader 4', label='D12', objectType='VFader', midi={0xB0,0x5D,MIDI_LSB}},
				{name='Fader 5', label='D13', objectType='VFader', midi={0xB0,0x49,MIDI_LSB}},
				{name='Fader 6', label='D14', objectType='VFader', midi={0xB0,0x48,MIDI_LSB}},
				{name='Fader 7', label='D15', objectType='VFader', midi={0xB0,0x05,MIDI_LSB}},
				{name='Fader 8', label='D16', objectType='VFader', midi={0xB0,0x54,MIDI_LSB}},
				...
				{name='Knob 6', label='B2', objectType='Knob', midi={0xB0,0x02,MIDI_LSB}},
				{name='Knob 7', label='B3', objectType='Knob', midi={0xB0,0x0C,MIDI_LSB}},
				{name='Knob 8', label='B4', objectType='Knob', midi={0xB0,0x0D,MIDI_LSB}},
